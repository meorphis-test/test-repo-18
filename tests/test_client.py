...
from meorphis_test_32._base_client import (
    DEFAULT_TIMEOUT,
...
class TestPetstore:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meorphis_test_32/_legacy_response.py",
                        "meorphis_test_32/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "meorphis_test_32/_compat.py",
    ...
    @mock.patch("meorphis_test_32._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncPetstore:
    ...
    def test_get_platform(self) -> None:
        ...
        from meorphis_test_32._utils import asyncify
        from meorphis_test_32._base_client import get_platform 
