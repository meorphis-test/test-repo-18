...
class PetsResource(SyncAPIResource):
    ...
    def updatededededed(
        ...
        *,
        ...
        photo_urls: List[str],
        id: int | NotGiven = NOT_GIVEN,
        category: pet_updatededededed_params.Category | NotGiven = NOT_GIVEN,
        status: Literal["available", "pending", "sold"] | NotGiven = NOT_GIVEN,
        tags: Iterable[pet_updatededededed_params.Tag] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                pet_updatededededed_params.PetUpdatedededededParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class PetsResourceWithRawResponse:
    def __init__(self, pets: PetsResource) -> None:
        ...
        self.updatededededed = to_raw_response_wrapper(
            pets.updatededededed,
        )
...
class AsyncPetsResourceWithRawResponse:
    def __init__(self, pets: AsyncPetsResource) -> None:
        ...
        self.updatededededed = async_to_raw_response_wrapper(
            pets.updatededededed,
        )
...
class PetsResourceWithStreamingResponse:
    def __init__(self, pets: PetsResource) -> None:
        ...
        self.updatededededed = to_streamed_response_wrapper(
            pets.updatededededed,
        )
...
class AsyncPetsResourceWithStreamingResponse:
    def __init__(self, pets: AsyncPetsResource) -> None:
        ...
        self.updatededededed = async_to_streamed_response_wrapper(
            pets.updatededededed,
        )
